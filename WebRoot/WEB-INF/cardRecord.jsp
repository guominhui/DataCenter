...
<link href="css/skins/molv/laydate.css" rel="stylesheet">
														...
														<c:forEach items="${list}" varStatus="i" var="item">
															<tr>
																...
																<td style="font-weight: normal;"><c:if
																		...
																		test="${item.sellToType==6}">代理-->玩家</c:if> <c:if
																		test="${item.sellToType==7}">总代-->总代</c:if>
