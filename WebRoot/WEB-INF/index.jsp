...
<body>
								...
								<div class="col-lg-7 col-md-12">
									<form class="testform" method="post">
										<table class="table table-bordered table-striped responsive"
											...
											<c:if test="${sessionScope.isCloseThreeLevelInstitution!=1&&sessionScope.userType==2}">
												<tr>
													<td>积分：</td>
													<td><input type="text" name="bonus" id="bonus"
														value="${bonus}"
														style="border:1px solid #b4b4b4;width:180px"
														readonly="readonly" /></td>
												</tr>
											...
											<tr>
												<td>限时房卡数量：</td>
												<td><input type="text" id="cardLCount"
													name="cardLCount" value="${cardLCount}"
													style="border:1px solid #b4b4b4;width:180px"
													readonly="readonly" /></td>
											</tr>
											<tr>
												<td>限时时间：</td>
												<td id="cardLTime"><fmt:formatDate value="${cardLTime}"
	...
	<script language="javascript">
		$(function() {
			if ("${cardLTime}" == "" || "${cardLTime}" == null || "${cardLTime}" == undefined){
				$('#cardLTime').text("暂无");
			}
		});
	</script>
